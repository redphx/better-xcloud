...
var SCRIPT_VERSION = "5.7.5", AppInterface = window.AppInterface;
UserAgent.init();
...
class RemotePlayNavigationDialog extends NavigationDialog {
  ...
  setupDialog() {
    const $fragment = CE("div", { class: "bx-remote-play-container" }), $settingNote = CE("p", {}), resolutions = [1080, 720], currentResolution = getPref("xhome_resolution"), $resolutionGroup = CE("div", {}), onResolutionChange = (e) => {
      const value = e.target.value;
    ...
    for (let resolution of resolutions) {
      ...
      if ($resolutionGroup.appendChild($label), currentResolution === value)
        $radio.checked = !0, $radio.dispatchEvent(new Event("input"));
    }
    const $qualitySettings = CE("div", {
      class: "bx-remote-play-settings"
    }, CE("div", {}, CE("label", {}, t("target-resolution"), $settingNote), $resolutionGroup));
