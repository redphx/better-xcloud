...
class StreamSettings {
  ...
  #handleSettingsNavigation($focusing, direction) {
    ...
    if (direction === NavigationDirection.UP || direction === NavigationDirection.DOWN) {
      ...
      const pseudo = direction === NavigationDirection.UP ? "last-of-type" : "first-of-type", $target = this.$settings.querySelector(`div[data-tab-group]:not(.bx-gone) div[data-focus-container]:${pseudo} [tabindex="0"]:last-of-type`);
      $target && $target.focus();
