...
class BxSelectElement {
  static wrap($select) {
    ...
    let visibleIndex = $select.selectedIndex, $checkBox, $label, $content;
    if (isMultiple)
      $content = CE("button", {
...
class StreamSettings {
  ...
  #setupDialog() {
    ...
    $tabs.firstElementChild.dispatchEvent(new Event("click")), document.documentElement.appendChild($overlay), document.documentElement.appendChild($container), onChangeVideoPlayerType();
  }
}
