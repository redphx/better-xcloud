...
const Texts = {
    ...
    "language": "Language",
    "large": "Large",
    "latency-test-again": "📡 Re-run test",
    "latency-test-button": "📡 Test server latency",
    "latency-test-default": "default",
    "latency-test-no-regions": "No regions available.",
    "latency-test-recommended": "recommended region",
    "latency-test-running": "📡 Testing…",
    "layout": "Layout",
