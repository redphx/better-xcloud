...
const Texts = {
    ...
    "custom": "Custom",
    "data-applied": "applied — effective from the next session launch",
    "data-current": "Current — max bitrate:",
    "data-preset-balanced": "⚖️ Balanced (recommended)",
    "data-preset-balanced-summary": "10 Mbps cap · keeps 1440p (~6.6 Mbps actual)",
    "data-preset-eco": "🌱 Eco",
    "data-preset-eco-summary": "5 Mbps cap · 720p (~4.7 Mbps actual)",
    "data-preset-max": "🚀 Max (default)",
    "data-preset-max-summary": "Unlimited bitrate · auto resolution",
    "data-usage": "📊 Data usage",
    "data-usage-note": "Based on our real measurements: the maxBitrate cap works reliably (keeps 1440p); the 1080p/1080p-hq resolutions have no effect on PC.",
